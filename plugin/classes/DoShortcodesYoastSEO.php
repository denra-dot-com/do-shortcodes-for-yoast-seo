...
class DoShortcodesYoastSEO extends Plugin {
    ...
    public function adminSettingsContent() {
        ...
        echo '<label for="wpseo_title"><input id="wpseo_title" name="wpseo_title" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['wpseo_title'] ? ' checked' : '') . ' /> ' . __('SEO Title', 'denra-do-sc-yoast-seo') . '</label>';
        echo '<label for="wpseo_metadesc"><input id="wpseo_metadesc" name="wpseo_metadesc" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['wpseo_metadesc'] ? ' checked' : '') . ' /> ' . __('SEO Description', 'denra-do-sc-yoast-seo') . '</label>';
        echo '</fieldset>';
        
        echo '<fieldset>';
        echo '<legend>' . __('Do shortcodes for Facebook (Open Graph)', 'denra-do-sc-yoast-seo') . '</legend>';
        echo '<label for="wpseo_opengraph_title"><input id="wpseo_opengraph_title" name="wpseo_opengraph_title" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['wpseo_opengraph_title'] ? ' checked' : '') . ' /> ' . __('Facebook Title', 'denra-do-sc-yoast-seo') . '</label>';
        echo '<label for="wpseo_opengraph_desc"><input id="wpseo_opengraph_desc" name="wpseo_opengraph_desc" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['wpseo_opengraph_desc'] ? ' checked' : '') . ' /> ' . __('Facebook Description', 'denra-do-sc-yoast-seo') . '</label>';
        echo '<label for="wpseo_opengraph_site_name"><input id="wpseo_opengraph_site_name" name="wpseo_opengraph_site_name" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['wpseo_opengraph_site_name'] ? ' checked' : '') . ' /> ' . __('Facebook Site Name', 'denra-do-sc-yoast-seo') . '</label>';
        echo '</fieldset>';
        
        echo '<fieldset>';
        echo '<legend>'  . __('Do shortcodes for Twitter', 'denra-do-sc-yoast-seo') . '</legend>';
        echo '<label for="wpseo_twitter_title"><input id="wpseo_twitter_title" name="wpseo_twitter_title" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['wpseo_twitter_title'] ? ' checked' : '') . ' /> ' . __('Twitter Title', 'denra-do-sc-yoast-seo') . '</label>';
        echo '<label for="wpseo_twitter_description"><input id="wpseo_twitter_description" name="wpseo_twitter_description" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['wpseo_twitter_description'] ? ' checked' : '') . ' /> ' . __('Twitter Description', 'denra-do-sc-yoast-seo') . '</label>';
        echo '</fieldset>';
        
        echo '<fieldset>';
        echo '<legend>'  . __('Do shortcodes in other locations', 'denra-do-sc-yoast-seo') . '<sup>1</sup></legend>';
        echo '<label for="wp_title"><input id="wp_title" name="wp_title" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['wp_title'] ? ' checked' : '') . ' /> ' . __('Post/Page Title', 'denra-do-sc-yoast-seo') . '</label>';
        echo '<label for="the_content"><input id="the_content" name="the_content" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['the_content'] ? ' checked' : '') . ' /> ' . __('Post/Page Content', 'denra-do-sc-yoast-seo') . '</label>';
        echo '<label for="nav_menu"><input id="nav_menu" name="nav_menu" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['nav_menu'] ? ' checked' : '') . ' /> ' . __('Navigation Menu', 'denra-do-sc-yoast-seo') . '</label>';
        echo '<label for="widget"><input id="widget" name="widget" type="checkbox" value="1"' . ($this->settings['do_shortcodes']['widget'] ? ' checked' : '') . ' /> ' . __('Widget Title and Content', 'denra-do-sc-yoast-seo') . '</label>';
        echo '</fieldset>';
